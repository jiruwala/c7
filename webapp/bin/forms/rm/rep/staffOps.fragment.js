sap.ui.jsfragment("bin.forms.rm.rep.staffOps", {
    ...
    createView: function () {
        ...
        var js = {
            title: Util.getLangText("Staff Operations"),
            title2: "",
            show_para_pop: false,
            reports: [
                {
                    code: "STAFFOP1",
                    name: Util.getLangText("Staff Operations"),
                    descr: Util.getLangText("Staff Operations"),
                    ...
                    onSubTitHTML: function () {
                        var tbstr = Util.getLangText("Staff Operations");
                    ...
                    rep: {
                        parameters: thatForm.helperFunc.getParas("STAFFOP1"),
                        print_templates: [
                        ],
                        canvas: [],
                        db: [
                            {
                                ...
                                filterCols: ["CAST_TYPE", "EMPNO", "EMPNAME", "TOTALQTY", "AMOUNT"],
                                ...
                                beforeLoadQry: function (sql) {
                                    var oy = thatForm.frm.getFieldValue("STAFFOP1@parameter.grpby");
                                    var iq = thatForm.frm.getFieldValue("STAFFOP1@parameter.incShift");
                                    // var cold = {                                        
                                    ...
                                    var sq = ("SELECT " +
                                        ...
                                        " and (':parameter.ploc' like '%\"'||c_order1.location_code||'\"%' ) " +
                                        " group by _grpby_txt , NAME " + (iq == "Y" ? " , cast_type " : "") +
                                        " ORDER BY EMPNO ").replaceAll("_grpby_txt", oy);
                                    return thatForm.frm.parseString(sq);
                                },
                                afterApplyCols: function (qryObj) {
                                    if (qryObj.name == "qry2") {
                                        // var iq = thatForm.frm.getFieldValue("parameter.grpby");
                                        var iq = thatForm.frm.getFieldValue("parameter.incShift");
                                        qryObj.obj.mLctb.cols[qryObj.obj.mLctb.getColPos("CAST_TYPE")].mHideCol = !(iq == "Y");
                                        qryObj.obj.mLctb.cols[qryObj.obj.mLctb.getColPos("EMPNO")].mGrouped = (iq == "Y");
                                        qryObj.obj.mLctb.cols[qryObj.obj.mLctb.getColPos("EMPNAME")].mGrouped = (iq == "Y");
                                    }
                                },
                                fields: thatForm.helperFunc.getFields("STAFFOP1")
        ...
        getParas: function (repCode) {
            ...
            var para = {
                ...
                grpby: {
                    ...
                    title: '{\"text\":\"grpByTxt\",\"width\":\"15%\","textAlign":"End","styleClass":""}',
                    title2: "",
                    display_width: colSpan,
                    ...
                    other_settings: {
                        ...
                        selectedKey: "issue_plant_no",
                    },
                    edit_allowed: true,
                    insert_allowed: true,
                    require: false,
                    dispInPara: true,
                    list: "@issue_plant_no/txtPumpDriver,ordered_key/txtPumpAsist,op_no/txtOpNo,ord_empno/txtDriver",
                },
                incShift: {
                    colname: "incShift",
                    data_type: FormView.DataType.String,
                    class_name: FormView.ClassTypes.CHECKBOX,
                    title: '@{\"text\":\"txtShift\",\"width\":\"15%\","textAlign":"End","styleClass":""}',
                    title2: "",
                    display_width: colSpan,
                    display_align: "ALIGN_LEFT",
                    display_style: "",
