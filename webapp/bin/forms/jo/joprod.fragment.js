sap.ui.jsfragment("bin.forms.jo.joprod", {
                ...
                db: [
                    {
                        type: "query",
                        name: "qry1",
                        dml: "select *from PORD_JO_STEPS_INFO where code=':pac'",
        ...
        getEvents: function () {
            ...
            return {
                ...
                afterLoadQry: function (qry) {
                    qry.formview.setFieldValue("pac", qry.formview.getFieldValue("qry1.code"));
                    if (qry.name == "qry1") {
                ...
                beforeDeleteValidate: function (frm) {
                    ...
                    if (qry.name == "qry1" && (qry.status == FormView.RecordStatus.EDIT) ||
                        ...
                        var vldtt = Util.getSQLValue(
                            "select nvl(max(PORD_KEYFLD),-1) from PORD_JO_STEPS where (" +
                            " step_code =" + no + ") "
                        );
                        if (Util.nvl(vldtt, -1) >= 0)
                            FormView.err("Err ! , Production Code is existed in JO , KEYID # " + vldtt);
                    }
                },
        ...
        getFields1: function () {
            ...
            return {
                ...
                descr: {
                    ...
                    data_type: FormView.DataType.String,
                    class_name: FormView.ClassTypes.TEXTFIELD,
                    title: '{\"text\":\"txtDescr\",\"width\":\"15%\","textAlign":"End","styleClass":""}',
                    title2: "",
                    canvas: "default_canvas",
                    display_width: codSpan,
                    display_align: "ALIGN_CENTER",
                ...
                remarks: {
                    ...
                    display_style: "",
                    display_format: "",
                    other_settings: { editable: true, width: "35%", rows: 2 },
                    edit_allowed: true,
                    insert_allowed: true,
                    require: false
                },
            ...
            return [
                {
                    ...
                    sql: "select code, DESCR " +
                        " from PORD_JO_STEPS_INFO order by CODE",
