sap.ui.jsfragment("bin.forms.rp.in.ss", {
    ...
    helperFunc: {
        ...
        getPara: function (repCode) {
            ...
            var para = {
                ...
                calcInUnit:
                {
                    ...
                    title: '{\"text\":\"Calc In Unit\",\"width\":\"15%\","textAlign":"End","styleClass":""}',
                    title2: "",
        ...
        addQry: function (qryObj, ps, repCode) {
            ...
            var calcUnit = thatForm.frm.getFieldValue("parameter.calcInUnit");
