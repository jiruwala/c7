sap.ui.jsfragment("bin.forms.rp.page", {
    ...
    createView: function () {
        ...
        var cmdLink = function (obj, rowno, colno, lctb, frm) {
            // var mdl = frm.objs["PAGE1@qry2"].obj.getControl().getModel();
            // var rr = frm.objs["PAGE1@qry2"].obj.getControl().getRows().indexOf(obj.getParent());
            // var cont = frm.objs["PAGE1@qry2"].obj.getControl().getContextByIndex(rr);
            // var rowid = mdl.getProperty("_rowid", cont);
            // var ac = Util.nvl(lctb.getFieldValue(rowid, "ACCNO"), "");
            // var ac = frm.objs["PAGE1@qry2"].obj.getControl().getRows()[rr].getCells()[0].getText();
                            ...
                            pcust: {
                                ...
                                other_settings: {
                                    ...
                                    change: function (e) {
                                        ...
                                        thatForm.frm.setFieldValue("PAGE1@parameter.pcust", vl, vl, false);
                                        var vlnm = Util.getSQLValue("select name from c_ycust where code=" + Util.quoted(vl));
                                        thatForm.frm.setFieldValue("PAGE1@parameter.acname", vlnm, vlnm, false);
                                    },
                                    valueHelpRequest: function (event) {
                                        Util.showSearchList("select code accno,name from c_ycust where childcount>0 and issupp='Y' order by path", "NAME", "ACCNO", function (valx, val) {
                                            thatForm.frm.setFieldValue("PAGE1@parameter.pcust", valx, valx, true);
                                            thatForm.frm.setFieldValue("PAGE1@parameter.acname", val, val, true);
                                        });
    ...
    save_cage: function () {
        ...
        var sqx1 = "SELECT   ACVOUCHER2.cust_code," +
            ...
            " and c_ycust.childcount=0 and c_ycust.issupp='Y' :KEYFLD_CONDITION " +
        ...
        var sqx2 = "SELECT   ACVOUCHER2.cust_code,  PATH," +
            ...
            " and c_ycust.path like parent_path " +
            " AND ACVOUCHER2.cust_code = c_ycust.code and issupp='Y' " +
        ...
        var paras = "rep_type varchar2(100) :='P';";
