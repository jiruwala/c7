                        ...
                        db: [
                            {
                                ...
                                execOnShow: false,
                                dml: "select a.*,decode(type,1,'Bank',2,'Cash') rec_type from ACC_TRANSACTION_up a where (a.cust_code=':parameter.pcust' or ':parameter.pcust' is null) and  a.vou_code in (2,3) and a.vou_date>=:parameter.fromdate  and a.vou_date<=:parameter.todate and a.vou_code=3 and debit>0 order by keyfld",
                                parent: "",
                                levelCol: "",
                                code: "",
                                title: "",
                                ...
                                filterCols: ["ACCNO", "DESCR2", "VOU_DATE", "DESCR"],
