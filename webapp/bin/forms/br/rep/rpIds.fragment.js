sap.ui.jsfragment("bin.forms.br.rep.rpIds", {
            ...
            reports: [
                {
                    ...
                    name: Util.getLangText("repDailySalesByDate"),
                    descr: Util.getLangText("repDailySalesByDate"),
    ...
    helperFunc: {
        ...
        addQry: function (qryObj, ps, repCode) {
            ...
            var sq = "select location_code,location_name,ord_date,ord_ship item,sum(ORD_PKQTY) QTY, " +
                " TO_CHAR(ord_date,'DD/MM/RRRR') DAT,ord_ship||'__QTY' ITEM_BAL " +
                " from joined_corder group by " +
                " location_code,location_name,ord_date ,ord_ship, " +
                " TO_CHAR(ord_date,'DD/MM/RRRR') ,ord_ship||'__QTY'" +
        ...
        getQry: function (qryObj) {
            ...
            Util.doAjaxJson("bat7getData", {
                ...
                if (dt.ret == "SUCCESS" && thatForm.qr != undefined) {
                    ...
                    ld.cols[ld.getColPos("QTY")].mUIHelper.display_format = "QTY_FORMAT";
                    /*
                    ...
                    */
                    ...
                    for (var li = 0; li < ld2.cols.length; li++)
                        if (ld2.cols[li].mColName.endsWith("__QTY")) {
                            var cn = ld2.cols[li].mColName.replaceAll("__QTY", "");
                    ...
                    ld2.cols[ld2.getColPos("tot__QTY")].mTitle = Util.getLangText("totalQty");
