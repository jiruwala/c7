sap.ui.jsfragment("bin.forms.br.rep.rpIcbr", {
    ...
    createView: function () {
        ...
        var js = {
            ...
            reports: [
                {
                    code: "ICSBR01", // Items Daily Sales
                    name: Util.getLangText("nameCustBranchSales"),
                    descr: Util.getLangText("nameCustBranchSales"),
                    ...
                    onSubTitHTML: function () {
                        var tbstr = Util.getLangText("nameCustBranchSales");
                    ...
                    rep: {
                        parameters: thatForm.helperFunc.getParas("ICSBR01"),
                        print_templates: [
                        ],
                        canvas: [],
                        db: [
                                ...
                                fields: {
                                    accno2: {
                                        ...
                                        bat7OnSetFieldAddQry: function (qryObj, ps) {
                                            return thatForm.helperFunc.addQry(qryObj, ps, "ICSBR01");
                                        },
    ...
    helperFunc: {
        ...
        addQry: function (qryObj, ps, repCode) {
            ...
            var sq = "select location_code,location_name,ord_ref,BRANCH_NAME branch,sum(:RTYPECOL) :REPCOLNAME , " +
                ...
                " group by  location_code,location_name,ord_ref ,BRANCH_NAME, " +
                " ord_ref||'-'||ord_refnm , ord_ship||'__:REPCOLNAME'" +
                " order by location_code,ord_ref,BRANCH_NAME";
        ...
        getQry: function (qryObj) {
            ...
            Util.doAjaxJson("bat7getData", {
                ...
                if (dt.ret == "SUCCESS" && thatForm.qr != undefined) {
                    ...
                    ld.cols[ld.getColPos("BRANCH_BAL")].ct_col = "Y";
