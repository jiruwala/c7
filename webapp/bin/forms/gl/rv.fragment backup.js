sap.ui.jsfragment("bin.forms.gl.rv", {
                ...
                form: {
                    ...
                    events: {
                        afterLoadQry: function (qry) {
                            ...
                            if (qry.name == "qry1") {
                                UtilGen.Search.getLOVSearchField("select name from salesp where no = :CODE ", qry.formview.objs["qry1.slsmn"].obj);
                                UtilGen.Search.getLOVSearchField("select title from accostcent1 where code = ':CODE' ", qry.formview.objs["qry1.costcent"].obj);
                                UtilGen.Search.getLOVSearchField("select name from acaccount where accno = ':CODE'", qry.formview.objs["qry1.code"].obj);
                                ...
                                if (dt.ret == "SUCCESS" && dt.data.length > 0) {
                                    ...
                                    if (dtx.length > 0 && dtx[0].FLAG != undefined && dtx[0].FLAG != 1) {
                                        setTimeout(function () {
                                            ...
                                            sap.m.MessageToast.show("This R.V. is posted !");
                                        });
                        ...
                        beforeDeleteValidate: function (frm) {
                            ...
                            if (dt.ret == "SUCCESS" && dt.data.length > 0) {
                                var dtx = JSON.parse("{" + dt.data + "}").data;
                                if (dtx.length > 0 && dtx[0].FLAG != undefined && dtx[0].FLAG != 1) {
                                    FormView.err("This R.V. is posted !");
                                }
                            }
                        },
                    ...
                    db: [
                        {
                            ...
                            fields: {
                                ...
                                no: {
                                    ...
                                    title: '{\"text\":\"NO\",\"width\":\"87px\","textAlign":"End","styleClass":""}',
                                    title2: "No",
                                    canvas: "default_canvas",
                                    display_width: codSpan,
                                ...
                                vou_date: {
                                    ...
                                    title: '@{\"text\":\"Vou Date\",\"width\":\"75px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: codSpan,
                                    display_align: "ALIGN_RIGHT",
                                ...
                                chequeno: {
                                    ...
                                    data_type: FormView.DataType.String,
                                    class_name: FormView.ClassTypes.TEXTFIELD,
                                    title: '@{\"text\":\"Chq #\",\"width\":\"60px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: codSpan,
                                    display_align: "ALIGN_RIGHT",
                                ...
                                duedate: {
                                    ...
                                    data_type: FormView.DataType.Date,
                                    class_name: FormView.ClassTypes.DATEFIELD,
                                    title: '@{\"text\":\"Due Date\",\"width\":\"70px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: codSpan,
                                    display_align: "ALIGN_RIGHT",
                                ...
                                descr: {
                                    ...
                                    data_type: FormView.DataType.String,
                                    class_name: FormView.ClassTypes.TEXTFIELD,
                                    title: '{\"text\":\"Descr\",\"width\":\"87px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                ...
                                code: {
                                    ...
                                    title: '{\"text\":\"Cash/Bank\",\"width\":\"87px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: fullSpan,
                                    display_align: "ALIGN_RIGHT",
                                    ...
                                    other_settings: {
                                        ...
                                        search: function (e) {
                                            ...
                                            UtilGen.Search.do_quick_search(e, this,
                                                ...
                                                "select accno code,name title from acaccount where accno=:CODE");
                                        }
                                    },
                                    edit_allowed: true,
                                    insert_allowed: true,
                                ...
                                rcvfrom: {
                                    ...
                                    data_type: FormView.DataType.String,
                                    class_name: FormView.ClassTypes.TEXTFIELD,
                                    title: '@{\"text\":\"Pay To\",\"width\":\"87px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: fullSpan,
                                    display_align: "ALIGN_RIGHT",
                                ...
                                slsmn: {
                                    ...
                                    data_type: FormView.DataType.String,
                                    class_name: FormView.ClassTypes.SEARCHFIELD,
                                    title: '{\"text\":\"Sales Person\",\"width\":\"87px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: fullSpan,
                                    display_align: "ALIGN_RIGHT",
                                    ...
                                    other_settings: {
                                        ...
                                        search: function (e) {
                                            UtilGen.Search.do_quick_search(e, this,
                                                ...
                                                "select no code,name title from salesp  where no=:CODE");
                                        }
                                    },
                                    edit_allowed: true,
                                    insert_allowed: true,
                                ...
                                costcent: {
                                    ...
                                    data_type: FormView.DataType.String,
                                    class_name: FormView.ClassTypes.SEARCHFIELD,
                                    title: '@{\"text\":\"Cost Center\",\"width\":\"87px\","textAlign":"End","styleClass":""}',
                                    title2: "",
                                    canvas: "default_canvas",
                                    display_width: fullSpan,
                                    display_align: "ALIGN_RIGHT",
                                    ...
                                    other_settings: {
                                        ...
                                        search: function (e) {
                                            UtilGen.Search.do_quick_search(e, this,
                                                ...
                                                "select code,title from accostcent1  where code=:CODE");
                                        }
                                    },
                                    edit_allowed: true,
                                    insert_allowed: true,
                        ...
                        },
                        {
                            ...
                            eventCalc: function (qv, cx, rowno, reAmt) {
                                ...
                                if (thatForm.view.byId("numtxt" + thatForm.timeInLong) != undefined)
                                    thatForm.view.byId("numtxt" + thatForm.timeInLong).setText(Util.getLangText("amountTxt")+" : " + df.format(sumCr));
