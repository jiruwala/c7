sap.ui.define("sap/ui/ce/generic/FormView", ["./QueryView"],
    function (QueryView) {
        ...
        FormView.prototype.parseForm = function (json) {
            ...
            //     }
            // ]);
            // this.form.canvases.array.forEach(element => {
            //     this.objs[element.name] = element;
            // });
            // this.objs["default_canvas"] = this.form.canvases[0];
            this.form.canvases = [];

            var cnvs = Util.nvl(json.form.canvas, [{
                name: "default_canvas",
                obj: undefined,
                objType: FormView.ObjTypes.CANVAS,
                classType: this.form.mainCanvas
            ...
            for (var i in lsts) {
                ...
                lst.list_para = lsts[i].list_para;
        ...
        FormView.prototype.createView = function () {
            ...
            this.view = Util.nvl(this.view, this.toolbarPg.getParent());
        ...
        FormView.prototype.deleteQryData = function (qryName) {
            ...
            if (thatForm.form.events.hasOwnProperty("afterDelSqlAdd")) {
                var sqAdd = Util.nvl(thatForm.form.events.afterDelSqlAdd(), "");
                sqAdd = this.parseString(sqAdd);
                sql += sqAdd
            }
        ...
        FormView.prototype.save_data = function (qryName, nxtStatus) {
            ...
            for (var o in qrys) {
                ...
                sq2 = "";
                if (!(qryObj.status == FormView.RecordStatus.EDIT || qryObj.status == FormView.RecordStatus.NEW))
                    FormView.err("This form is Not in EDIT/NEW Mode !");
